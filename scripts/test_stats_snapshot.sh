...
xcrun swiftc -parse-as-library "$task_test_dir/Entry.swift" "$task_test_dir/Audio.swift" Sources/Fluid/UI/StatsSnapshot.swift Sources/Fluid/UI/StatsActivityPeriod.swift Sources/Fluid/UI/StatsSnapshotStore.swift Tests/StatsSnapshotStoreFixtures.swift Tests/StatsSnapshotTests.swift -o "$task_test_dir/tests"
"$task_test_dir/tests"
